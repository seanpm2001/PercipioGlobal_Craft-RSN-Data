...
namespace percipioglobal\rsndata\fields;

use percipioglobal\rsndata\RsnData;
use percipioglobal\rsndata\assetbundles\rsndatafieldfield\RsnDataFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class RsnDataField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('rsn-data', 'RsnDataField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'rsn-data/_components/fields/RsnDataField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(RsnDataFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').RsnDataRsnDataField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'rsn-data/_components/fields/RsnDataField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
