...
namespace percipioglobal\rsndata\widgets;

use percipioglobal\rsndata\RsnData;
use percipioglobal\rsndata\assetbundles\dataengagementwidget\DataEngagementWidgetAsset;
 ...
 * @since     1.0.0
 */
class DataEngagement extends Widget
{
    ...
    {
        return Craft::t('rsn-data', 'DataEngagement');
    }
    ...
    {
        return Craft::getAlias("@percipioglobal/rsndata/assetbundles/dataengagementwidget/dist/img/DataEngagement-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'rsn-data/_components/widgets/DataEngagement_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(DataEngagementWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'rsn-data/_components/widgets/DataEngagement_body',
            [
